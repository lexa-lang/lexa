  ...
  ((((i64)(boolAnd((int64_t)(((i64)(boolAnd((int64_t)(queen != q), (int64_t)(queen != (q + diag)))))), (int64_t)(queen != (q - diag)))))) ? (({closure_t* __clo__ = (closure_t*)safe;
  i64 __f__ = (i64)(__clo__->func_pointer);
  i64 __env__ = (i64)(__clo__->env);
  ((i64(*)(i64, i64, i64, i64))__f__)(__env__,queen,(diag + 1),qs);
  })) : 0);});}));}));
  }
  
  static i64 __place_lifted_2__(i64 __env__,i64 size,i64 column,i64 search_stub) {
  return(((column == 0) ? (((i64)(listEnd()))) : ({i64 rest = (i64)(({closure_t* __clo__ = (closure_t*)place;
  i64 __f__ = (i64)(__clo__->func_pointer);
  i64 __env__ = (i64)(__clo__->env);
  ((i64(*)(i64, i64, i64, i64))__f__)(__env__,size,(column - 1),search_stub);
  }));
  ...
  })) ? (((i64)(listNode((int64_t)next, (node_t*)rest)))) : (RAISE(search_stub, fail, (0))));});})));
  }
  ...
  return(((i == size) ? (a + (FINAL_THROW(k, i))) : (({closure_t* __clo__ = (closure_t*)loop;
  i64 __f__ = (i64)(__clo__->func_pointer);
  i64 __env__ = (i64)(__clo__->env);
  ((i64(*)(i64, i64, i64, i64, i64))__f__)(__env__,(i + 1),(a + (THROW(k, i))),size,k);
  }))));
  }
