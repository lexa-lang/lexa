  ...
  static i64 __is_even_lifted_1__(i64 __env__, i64 n) {
    return (({
      closure_t *is_even = xmalloc(sizeof(closure_t));
  ...
  int main(int argc, char *argv[]) {
    ...
    i64 __res__ = ({
      i64 _ =
          (i64)((i64)(printInt((int64_t)(((i64(*)(i64, i64))__is_even_lifted_1__)(
