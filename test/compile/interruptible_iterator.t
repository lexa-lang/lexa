    ...
    return (({
      ...
      ({
        ...
        (({
          ...
          ((i64(*)(i64, i64, i64, i64))__f__)(__env__, it_tail, yield_stub,
                                              behead_stub);
        }));
      });
    }));
  ...
  static i64 __loop_lifted_1__(i64 __env__, i64 it, i64 yield_stub,
                               i64 behead_stub) {
    return (({
      i64 _ = (i64)(HANDLE(loop_body_1, ({TAIL, replace_loop_replace}),
                           (it, yield_stub, behead_stub)));
      ({
        ...
        ({
          ...
          ({
            ...
            ({
              i64 newtl =
                  (i64)(cond ? (((i64)(listEnd())))
                             : (HANDLE(loop_body_2, ({TAIL, loop_behead_behead}),
                                       (it_tail, yield_stub, beheaded))));
              ({
    ...
    return (({
      ...
      ({
        ...
        (({
          ...
          i64 __f__ = (i64)(__clo__->func_pointer);
          i64 __env__ = (i64)(__clo__->env);
          ((i64(*)(i64, i64, i64, i64))__f__)(__env__, l, yield_stub,
                                              behead_stub);
        }));
      });
    }));
  ...
  i64 yield_main_yield(i64 *env, i64 x, i64 behead_stub, i64 replace_stub) {
    return (({
      i64 cond = (i64)(x < 0);
      (cond ? (RAISE(behead_stub, behead, (0))) : ({
        i64 x2 = (i64)(x * 2);
  ...
  static i64 __listSum_lifted_2__(i64 __env__, i64 l, i64 acc) {
    return (({
      i64 cond = (i64)(((i64)(listIsEmpty((node_t *)l))));
      (cond ? acc : ({
        i64 head = (i64)(((i64)(listHead((node_t *)l))));
        ({
    ...
    return (({
      ...
      ({
        ...
        ({
          ...
          ({
            i64 newtl = (i64)(HANDLE(body_main_1, ({TAIL, behead_main_behead}),
                                     (l, beheaded)));
            ({
              i64 tobehead = (i64)(((i64 *)beheaded)[0]);
              ({
                i64 res = (i64)(tobehead ? (((i64)(listTail((node_t *)newtl))))
                                         : newtl);
                (({
                  closure_t *__clo__ = (closure_t *)listSum;
                  i64 __f__ = (i64)(__clo__->func_pointer);
