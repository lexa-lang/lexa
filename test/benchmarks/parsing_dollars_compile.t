  $ sstal ../../benchmarks/lexi/parsing_dollars/main.lx -o main.c
  $ cat main.c
  #include <stdint.h>
  #include <stdlib.h>
  #include <stdio.h>
  ...
  static i64 __newline_lifted_1__(i64 __env__) {
  return(10);
  }
  
  static i64 __is_newline_lifted_2__(i64 __env__,i64 c) {
  return((c == 10));
  }
  
  static i64 __dollar_lifted_3__(i64 __env__) {
  return(36);
  }
  
  static i64 __is_dollar_lifted_4__(i64 __env__,i64 c) {
  return((c == 36));
  }
  ...
  return((HANDLE(__handle_body_lifted_16__, ({ABORT, __stop_stub_lifted_17___stop}), ((i64)action, (i64)emit_stub, (i64)n))));
  }
  ...
  return(({i64 action = (i64)(((i64*)__env__)[0]);
  ...
  ((i64(*)(i64, i64, i64, i64))__f__)(__env__,read_stub,emit_stub,stop_stub);
  }));});});});});});});});}));
  }
