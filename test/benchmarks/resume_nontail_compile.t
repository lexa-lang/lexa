  $ lexa ../../benchmarks/lexa/resume_nontail/main.lx -o main --output-c &> /dev/null
  $ cat ../../benchmarks/lexa/resume_nontail/main.c
  ...
  static i64 __run_lifted_2__(i64 __env__, i64 n, i64 s) {
    return ((HANDLE(__handle_body_lifted_6__,
                    ({SINGLESHOT, __operator_stub_lifted_7___operator}),
  ...
  static i64 __repeat_lifted_4__(i64 __env__, i64 n) {
    return ((((i64(*)(i64, i64, i64, i64))__step_lifted_3__)((i64)0, (i64)1000,
                                                             (i64)0, (i64)n)));
  }
  ...
  int main(int argc, char *argv[]) {
    ...
    i64 __res__ = ({
      ((i64)(printInt((int64_t)(((i64(*)(i64, i64))__repeat_lifted_4__)(
  ...
  static i64 __handle_body_lifted_6__(i64 __env__, i64 operator_stub) {
    return (({
      ...
      ({
        ...
        ({
          i64 s = (i64)(((i64 *)__env__)[2]);
          (((i64(*)(i64, i64, i64, i64))__loop_lifted_1__)((i64)0, (i64)n, (i64)s,
                                                           (i64)operator_stub));
        });
      });
    }));
