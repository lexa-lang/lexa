  $ lexa ../../benchmarks/lexa/product_early/main.lx -o main.c
  $ cat main.c
  #include <stdint.h>
  #include <stdlib.h>
  #include <stdio.h>
  ...
  return(((i == 0) ? a : (({__attribute__((musttail))
   return ((i64(*)(i64, i64, i64, i64))__loop_lifted_4__)((i64)0, (i64)xs, (i64)(i - 1), (i64)(a + (((i64(*)(i64, i64))__runProduct_lifted_3__)((i64)0, (i64)xs)))); 0;}))));
  }
  
  static i64 __run_lifted_5__(i64 __env__,i64 n) {
  return((((i64(*)(i64, i64, i64, i64))__loop_lifted_4__)((i64)0, (i64)(((i64(*)(i64, i64))__enumerate_lifted_2__)((i64)0, (i64)1000)), (i64)n, (i64)0)));
  }
  ...
  return(({i64 product = (i64)(((i64*)__env__)[0]);
  ({i64 xs = (i64)(((i64*)__env__)[1]);
  (((i64(*)(i64, i64, i64))__product_lifted_1__)((i64)0, (i64)xs, (i64)abort_stub));});}));
  }
